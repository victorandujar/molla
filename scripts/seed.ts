...
try {
  await sql.begin(async (tx) => {
    await tx`INSERT INTO bakes(id,number,pickup_date,deadline,opens_at,capacity,status,pickup_window) VALUES(${bake.id},${bake.number},${bake.pickupDate},${bake.deadline},${bake.opensAt},${bake.capacity},${bake.status},${bake.pickupWindow || null}) ON CONFLICT(id) DO NOTHING`;
